...
prgmemtab   db "SymExe10"           ;SymbOS-EXE-Kennung                 POST Tabelle Speicherbereiche
            ...
            dw 81*25                ;zusätzlicher Data-Speicher
...
trmbuf  ds 80   ;Buffer für Textausgabe
...
winini1 ld (ix+0),l
        ...
        sub 4
        inc hl
        inc hl                  ;HL=Xlen in Pixeln+4, A=Ylen in Pixeln+4
        ld (prgwindat+08),hl
        ld (prgwindat+10),a
        ld (prgwindat+20),hl
        ld (prgwindat+22),a
        ...
        sub 13
        ld (16*8+prgwinobj0+8),a
        add 5
        ld (16*7+prgwinobj0+8),a
        inc a
        ld (16*6+prgwinobj0+8),a
        ld a,(memcfl)
        or a
        ret z
        ld de,(memcps)
...
winfll2 push bc             ;*** Leerzeichen-Sonderfall
        ...
        ld (prgwinobj0+32+8),a
        pop de
        call wincon0
        dec hl:dec hl
        sub 8
        ld (prgwinobj0+32+10),hl
        ld (prgwinobj0+32+12),a
        ld e,29
        jr winplt0
...
wincon1 call wincon0
        ...
        ld (0*16+prgwinobj0+8),a
        ld (9*16+prgwinobj0+6),hl
        ld (9*16+prgwinobj0+8),a
        ld a,5
        ld (prgwinobj0+2),a
        ret
wincon0 ld a,e
...
prgwingrp db 28,0:dw prgwinobj,0,0,0,0,0,0
prgwinobj
...
configinp0  dw configbuf0,0,0,0,0,2,0
configbuf0  ds 3
